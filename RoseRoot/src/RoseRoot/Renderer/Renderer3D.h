...
namespace Rose {
	...
	public:
		...
		static void DrawDirLight(const glm::vec3& direction, const glm::vec3& ambient = glm::vec3(0.01f, 0.01f, 0.01f), const glm::vec3& diffuse = glm::vec3(0.025f, 0.025f, 0.025f), const glm::vec3& specular = glm::vec3(0.025f, 0.025f, 0.025f));

		static void DrawCube(const glm::mat4& transform = glm::mat4(1.0f), const glm::vec4& color = glm::vec4(1.0f));

		static void DrawCube(const Ref<Texture2D>& texure, const glm::mat4& transform = glm::mat4(1.0f), const float& tile = 1.0f, const glm::vec4& color = glm::vec4(1.0f));
